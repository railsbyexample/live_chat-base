(->
  ...
  this.App || (this.App = {})
  this.App.ConversationsShow || (this.App.ConversationsShow = {})

  this.App.ConversationsShow.init = ->
  ...
  this.App.ConversationsShow.scroll_to_bottom = -> window.scrollTo(0, document.body.scrollHeight)

  this.App.ConversationsShow.append_message = (message) ->
  ...
  this.App.ConversationsShow.submit_message = (e) ->
